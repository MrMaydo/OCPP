...
import maydo.ocpp.msgDef.Enumerations.PriorityChargingStatusEnum;
 ...
 */
public class UsePriorityChargingResponse implements JsonInterface {
    ...
    public void setStatus(PriorityChargingStatusEnum status) {
        this.status = status;
    }
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = PriorityChargingStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof UsePriorityChargingResponse))
            return false;
        UsePriorityChargingResponse that = (UsePriorityChargingResponse) obj;
