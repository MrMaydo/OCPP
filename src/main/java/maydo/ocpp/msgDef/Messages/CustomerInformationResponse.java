...
import maydo.ocpp.msgDef.Enumerations.CustomerInformationStatusEnum;
...
public class CustomerInformationResponse implements JsonInterface {
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = CustomerInformationStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof CustomerInformationResponse))
            return false;
        CustomerInformationResponse that = (CustomerInformationResponse) obj;
