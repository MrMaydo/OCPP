...
/**
 * The NotifyChargingLimitResponse message is sent by
 * the CSMS to the Charging Station in response to a NotifyChargingLimitsRequest.
 * No fields are defined
 */
public class NotifyChargingLimitResponse implements JsonInterface {
