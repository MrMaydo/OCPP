...
/**
 * This contains the field definition of the ReserveNowResponse PDU sent by
 * the Charging Station to the CSMS in response to ReserveNowRequest PDU.
 */
public class ReserveNowResponse implements JsonInterface {
    ...
    public ReserveNowResponse(ReserveNowStatusEnum status, StatusInfo statusInfo, CustomData customData) {
        super();
        this.status = status;
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = ReserveNowStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
