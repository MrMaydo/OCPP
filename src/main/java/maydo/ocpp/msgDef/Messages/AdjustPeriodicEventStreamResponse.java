...
public class AdjustPeriodicEventStreamResponse implements JsonInterface {
     ...
     */
    public AdjustPeriodicEventStreamResponse() {
    }

    public AdjustPeriodicEventStreamResponse(GenericStatusEnum status, StatusInfo statusInfo, CustomData customData) {
        super();
        this.status = status;
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof AdjustPeriodicEventStreamResponse))
            return false;
