...
/**
 * This contains the field definition of the CertificateSignedResponse PDU sent by
 * the Charging Station to the CSMS in response to a CertificateSignedRequest.
 */
public class CertificateSignedResponse implements JsonInterface {
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = CertificateSignedStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
