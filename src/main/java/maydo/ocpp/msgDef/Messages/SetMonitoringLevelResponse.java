...
/**
 * This contains the field definition of the SetMonitoringLevelResponse PDU sent by
 * the Charging Station to the CSMS in response to a SetMonitoringLevelRequest.
 */
public class SetMonitoringLevelResponse implements JsonInterface {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof SetMonitoringLevelResponse))
            return false;
        SetMonitoringLevelResponse that = (SetMonitoringLevelResponse) obj;
