...
/**
 * This contains the field definition of the SendLocalListResponse PDU sent by
 * the Charging Station to the CSMS in response to SendLocalListRequest PDU.
 */
public class SendLocalListResponse implements JsonInterface {
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = SendLocalListStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof SendLocalListResponse))
            return false;
        SendLocalListResponse that = (SendLocalListResponse) obj;
