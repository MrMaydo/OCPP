...
import maydo.ocpp.msgDef.Enumerations.TariffChangeStatusEnum;
 ...
 *
 */
public class ChangeTransactionTariffResponse implements JsonInterface {

    /**
     * Status of the operation
     */
    @Required
    private TariffChangeStatusEnum status;
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = TariffChangeStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (!(obj instanceof ChangeTransactionTariffResponse))
            return false;
