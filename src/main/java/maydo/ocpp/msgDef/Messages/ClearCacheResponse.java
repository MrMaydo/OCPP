...
/**
 * This contains the field definition of the ClearCacheResponse PDU sent by
 * the Charging Station to the CSMS in response to a ClearCacheRequest.
 */
public class ClearCacheResponse implements JsonInterface {
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = ClearCacheStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ClearCacheResponse))
            return false;
        ClearCacheResponse that = (ClearCacheResponse) obj;
