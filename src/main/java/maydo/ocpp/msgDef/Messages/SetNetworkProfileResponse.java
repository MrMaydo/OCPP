...
/**
 * This contains the field definition of the SetNetworkProfileResponse PDU sent by
 * the Charging Station to the CSMS in response to a SetNetworkProfileRequest.
 */
public class SetNetworkProfileResponse implements JsonInterface {
    ...
    public void fromJsonObject(JsonObject jsonObject) {
        if (jsonObject.has("status")) {
            this.status = SetNetworkProfileStatusEnum.valueOf(jsonObject.get("status").getAsString());
        }
